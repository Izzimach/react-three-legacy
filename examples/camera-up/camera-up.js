...
var OrbitCamera = React.createClass({
  ...
  render: function() {
    ...
    var cameraup = new THREE.Vector3(0, Math.cos(this.props.tilt), Math.sin(this.props.tilt));
    cameraposition.applyQuaternion(orbitquaternion);
    cameraup.applyQuaternion(orbitquaternion);
